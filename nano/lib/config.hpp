...
public:
		...
		publish_thresholds (is_live_network () ? publish_full : is_beta_network () ? publish_beta : is_test_network () ? publish_test : publish_dev)
	{
		...
		default_node_port = is_live_network () ? 8075 : is_beta_network () ? 54000 : is_test_network () ? test_node_port () : 44000;
		default_rpc_port = is_live_network () ? 8076 : is_beta_network () ? 55000 : is_test_network () ? test_rpc_port () : 45000;
		default_ipc_port = is_live_network () ? 8077 : is_beta_network () ? 56000 : is_test_network () ? test_ipc_port () : 46000;
		default_websocket_port = is_live_network () ? 8078 : is_beta_network () ? 57000 : is_test_network () ? test_websocket_port () : 47000;

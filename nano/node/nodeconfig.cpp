...
const char * default_beta_peer_network = "peering-beta.myd.money";
const char * default_live_peer_network = "peering.myd.money";
const std::string default_test_peer_network = nano::get_env_or_default ("NANO_TEST_PEER_NETWORK", "peering-test.myd.money");
}
